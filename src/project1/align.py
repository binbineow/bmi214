    ...
    def output_path(self,project_input,type0,i,j,seqA0,seqB0,list0):  
        ...
        if (is_same(getattr(self,'matrix_'+type0)[i,j],0) and project_input.is_local):
            ...
            if not type0 == 'M':
                ...
                print('I')
                print([adding_A+seqA0,adding_B+seqB0])
...
def main():
    ...
    print(sw_map.matrix_Ix)
    print(sw_map.matrix_Iy)
    list_alignment = []
    print(project_input.seqA[best_i-1],project_input.seqB[best_j-1])
